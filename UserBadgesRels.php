...
/**
 * @author Ashish Kumar
 * @desc Plural Model class for GamificationUserBadgesRel DB class
 */
class Gamification_UserBadgesRels extends Gamification_AbstractPlural {

    protected $_dbClass = 'UserBadgesRel';
     ...
     */
    public function getAllGamificationUserBadgesRelData($userId=0, $publicationId=0) {
        try {
