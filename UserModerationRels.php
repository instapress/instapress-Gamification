...
/**
 * @author Ashish Kumar
 * @desc Plural Model class for GamificationUserModerationRel DB class
 */
class Gamification_UserModerationRels extends Gamification_AbstractPlural {

    protected $_dbClass = 'UserModerationRel';
     ...
     */
    public function getAllGamificationUserModerationRelData($userId=0, $publicationId=0,$clientId=1) {
        try {
