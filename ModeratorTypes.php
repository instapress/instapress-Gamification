...
/**
 * @author Ashish Kumar
 * @desc Plural Model class for GamificationModeratorType DB class
 */
class Gamification_ModeratorTypes extends Gamification_AbstractPlural {

    protected $_dbClass = 'ModeratorType';
     ...
     */
    public function getAllGamificationModeratorTypeData($publicationId=0,$clientId=1) {
        try {
